class Restaurant {
  ...
  Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    this.id = json['id'];
    this.icon = json['icon'];
    this.htmlPhotoLink = json['photos'][0]['html_attributions'][0].substring(json['photos'][0]['html_attributions'][0].indexOf("\"") + 1, json['photos'][0]['html_attributions'][0].lastIndexOf("\""));
